...
public class ELTestServlet2 extends HttpServlet{
	...
	session.setAttribute("sessionValue", "session scope에 세팅한 값");
	...
	// 1) application scope 객체 얻어오기 이름이getServletContext로 되어있음
	//req 말고 session 으로 해도 얻어올수 있음 
